package com.example.androidthings.weatherstation.driver;
...
public class Bmx280 implements AutoCloseable {
    ...
    static float[] compensateTemperature(int rawTemp, int[] calibrationData) {
        ...
        double adc_T = (double) rawTemp;
        double var1 = (adc_T / 16384f - ((double) dig_T1) / 1024f) * ((double) dig_T2);
        double var2 = ((adc_T / 131072f - ((double) dig_T1) / 8192f) * (adc_T / 131072f
                - ((double) dig_T1) / 8192f)) * ((double) dig_T3);
